...
{
  [CreateAssetMenu(menuName = "Upgrades/Tank Upgrade")]
  public class TankUpgrade : Upgrade
  {
    [Header("Tank Modifiers")]
    [Tooltip("How much damage the player can take.")]
    public FloatModifier Health;
    [Tooltip("How much health is regenerated per second.")]
    public FloatModifier HealthRegeneration;
